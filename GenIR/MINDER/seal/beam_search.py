...
def fm_index_generate(
    ...
    **kwargs,
    ...
    generation_config = {'repetition_penalty': None, 'no_repeat_ngram_size': 0, 'encoder_no_repeat_ngram_size': 0,
                         'bad_words_ids': None, 'forced_eos_token_id': None, 'num_beam_groups': 1,
                         'diversity_penalty': 0.0, 'remove_invalid_values': True,
                         'forced_bos_token_id': forced_bos_token_id, 'encoder_no_repeat_ngram_size': 0,
                         'bad_words_ids': None, 'min_length': min_length, 'max_length': max_length,
                         'eos_token_id': None, 'prefix_allowed_tokens_fn': None, 'forced_eos_token_id': None,
                         'num_beams': num_beams, 'diversity_penalty': 0.0, 'remove_invalid_values': True}
